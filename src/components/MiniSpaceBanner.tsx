                                    ...
                                    <AnimatePresence>
                                        {showPinInput && (
                                            <motion.div
                                                ...
                                                animate={{ opacity: 1, y: 0, scale: 1 }}
                                                exit={{ opacity: 0, y: -10, scale: 0.95 }}
                                                className="fixed top-24 left-2 right-2 sm:absolute sm:top-full sm:right-0 sm:left-auto sm:w-[450px] sm:mt-3 bg-[#1a1a1a] border border-white/10 rounded-xl shadow-2xl overflow-hidden p-3 z-[60]"
                                            >
                                                ...
                                                <div className="flex gap-2">
                                                    <input
                                                        ...
                                                        className="flex-1 min-w-0 bg-black/50 border border-white/10 rounded px-2 py-1 text-xs text-white focus:outline-none focus:border-blue-500"
                                                    />
                                                    <button
                                                        onClick={() => {
                                                            onPinTweet(tweetUrl);
                                                        ...
                                                        className="px-3 py-1 shrink-0 bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold rounded transition-colors"
                                                    >
                                                        Pin
                                                    </button>
                                                </div>
