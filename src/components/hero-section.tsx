        ...
        <div className="relative z-10 px-4 pb-8">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <motion.div
                className="bg-white/5 border-white/20 backdrop-blur-sm rounded-2xl border p-8 flex flex-col justify-between"
              ...
              >
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm">
                      Just a few seconds of your voice is enough to create a
                      deepfake clone. Secure your unique voiceprint to prevent
                      these attacks.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm">
                      The voice extends to your social presence, mint your own
                      creator coin to use your existing social data to
                      participate in Mindshare Capital Markets.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm">
                      Your voice has value! Share cutting-edge crypto projects
                      with the world to monetize your opinions and be rewarded
